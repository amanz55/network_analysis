...
class SlackDataLoader:
    ...
    def __init__(self):
        ...
        '''
        self.path = 'c:/Users/amanu/Documents/10 Academy/network_analysis/data/anonymized/'
    ...
    def create_data_frame(self):
        ...
        for channel_name in channel_names:
            channel_path = '../data/anonymized/' + channel_name + '/'
            channel_df = self.slack_parser(channel_path)
    ...
    def create_reaction_data_frame(self):
        ...
        for name in channel_names:
            ...
            channel_dataframe = self.parse_slack_reaction(channel_path, name)
...
if __name__ == "__main__":
    ss = SlackDataLoader()
    ss.slack_parser('../data/anonymized/all-community-building/')
